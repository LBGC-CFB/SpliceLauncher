...
* [Getting started](#2)
    ...
    * [Installing SpliceLauncher](#8)
        * [Creating the reference files](#9)
            ...
            * [Reference files used by SpliceLauncher](#11)
...
2. Donwload the GTF annotation file: from [UCSC table browser](https://genome.ucsc.edu/cgi-bin/hgTables "Title"), with hg19 example:
...
#### Reference files used by SpliceLauncher <a id="11"></a>
